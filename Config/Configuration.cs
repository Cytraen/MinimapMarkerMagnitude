...
public class Configuration : IPluginConfiguration
{
	...
	{
		return new List<MinimapIconGroup>
		{
			new()
			{
				GroupName = "Guilds",
				Enabled = false,
				GroupIconIds = new HashSet<int>
				{
					60318, 60319, 60320, 60321, 60322, 60326, 60330, 60331, 60333, 60334, 60335, 60337, 60342, 60344, 60345, 60346, 60347, 60348, 60351, 60362, 60363, 60364,
				}
			},
			new()
			{
